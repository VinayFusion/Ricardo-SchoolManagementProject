...
function GetProfileData() {
    //generateCaptcha('mainCaptcha', 'inputCaptcha', 'mainCaptcha_error');
...
function AddUpdateAdmin() {
    ...
    //        _is_valid = false;
    //        $("#UserName_error_ManageProfile").html('Please enter UserName!');
    //    }
    //}
    ...
    //if (_captcha == 0) {
    //    _is_valid = false;
    //    CheckCaptcha('mainCaptcha', 'inputCaptcha', 'mainCaptcha_error');
    //}
    if (_is_valid == true) {
        StartLoading();
        ...
        $.ajax({
            ...
            success: function (dataResponse) {
                ...
                if (dataResponse.status == 1) {
                    ...
                    $("#txtFirstName_ManageProfile").val('');
                    $("#txtLastName_ManageProfile").val('');
                    if (logged_In_UserType_Global == 1) {
                        $("#txtEmail_ManageProfile").val('');
                    }
                    /*$("#txtUserName_ManageProfile").val('');*/
                    $("#txtMobile_ManageProfile").val('');
                    $("#txtPincode_ManageProfile").val('');
                    $("#txtAddress_ManageProfile").val('');
